    ...
    public partial class Data : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("88738493-3a85-4443-8f6a-313453432192"), "Địa Lý", "Hiểu rõ về địa hình địa lý trong nước..." },
                    { new Guid("9250d994-2558-4573-8465-417248667051"), "Tin Học", "Hổ trợ về tin học cơ bản" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("4e79044a-988d-4488-97b7-3e474e4340d2"), "Nguyễn Thành Thông" },
                    { new Guid("e2397972-8743-431a-9482-60292f08320e"), "Nguyễn Hữu Thạch" }
                });
